...
-- and scaffolded external payment provider Issuing cards are all going away.
--
...
-- 3. User-side external payment provider autopay infrastructure (SPT + MPP receipts + Issuing cards).

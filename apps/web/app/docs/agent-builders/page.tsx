            ...
            <tbody>
              {(
                [
                  ...
                  ['payments', 'external payment provider, Paddle, LemonSqueezy.'],
...
# if the user explicitly asked for a non-rotating token.`}
      ...
      <Section title="Local plan and quota status">
        Tenants use local plan and quota records while Cumulus billing is
        redesigned. Agents can inspect the state, but they cannot start a
        payment flow:
        <Pre>

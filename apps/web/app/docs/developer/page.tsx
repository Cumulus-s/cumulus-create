...
{ kind: 'teardown', account_id: '<id>' }`}</pre>
      ...
      <Row label="The decision — should I integrate with Relay?">
        ...
        agent-side wiring yourself. You keep your own auth (Cumulus-native,
      ...
      <Row label="Delete a workspace">
        ...
        deletion while external payment provider considers the workspace <code style={inlineCode}>trialing</code>,{' '}

      ...
      <div style={wrap}>
        ...
        <section style={grid}>
          <div style={panel}>
            ...
            <p style={lead}>
              The agent signs up, registers the intent, runs `npm create @cmls`, wires Auth, DB,
        ...
        >
          {[
            ...
            ['02', 'Project bootstraps', '@cmls/create installs npm, Rust, and Python runtime wiring.'],

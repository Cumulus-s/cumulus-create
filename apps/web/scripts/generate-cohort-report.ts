...
- **Activation** = first successful \`authenticated_api_call_succeeded\` event, reported by your middleware via \`@cumulus_cloud/track\`, occurring within 24 hours of the genuine key handoff (\`signup_jobs.handoff_at\`).

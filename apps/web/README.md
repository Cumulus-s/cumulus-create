...
- Optional provider credentials for Neon, Vercel, Resend, external payment provider, SendGrid, and
...
4. Configure external payment provider if you want billing.
...
```text
packages/
├── create-cumulus/  @cmls/create npm creator package

...
--    external payment provider (`subscription.items.data[0].price.recurring.interval`).
...
--    pack from /v1/dev/billing/credits/checkout. external payment provider Checkout completes,

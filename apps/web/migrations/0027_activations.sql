...
--    in; 'lapsed' = sprint ended without renewal. external payment provider webhook flips
...
CREATE TABLE IF NOT EXISTS "tenant_tracking_secrets" (
  ...
  -- (external payment provider restricted-key pattern). Never echoed back in API responses.

...
| `@cls/auth`, `@cls/db`, and `@cls/sdk` | Apache-2.0 | Public app-side integration helpers should be easy to adopt, fork, and use commercially. |
...
- Do not import `@cls/cumulus-db` or `apps/cumulus-db` source from Apache-side SDK code.

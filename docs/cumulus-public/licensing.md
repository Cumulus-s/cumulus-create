...
| `@cumulus/auth`, `@cumulus/db`, and `@cumulus/sdk` | Apache-2.0 | Public app-side integration helpers should be easy to adopt, fork, and use commercially. |
...
- Do not import `@cumulus/database` or `apps/cumulus-db` source from Apache-side SDK code.
